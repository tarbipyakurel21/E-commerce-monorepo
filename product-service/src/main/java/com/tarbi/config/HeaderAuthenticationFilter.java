...
public class HeaderAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected boolean shouldNotFilter(HttpServletRequest request) {
        ...
        if (method.equalsIgnoreCase("GET") && path.startsWith("/api/products")) {
            return true;
        }
        
        // Check if internal requests like feign Client request
        String internal=request.getHeader("Internal-Call");
